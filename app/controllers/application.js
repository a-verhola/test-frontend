      ...
      nodes: [
        {
          ...
          children: [{
            link: 'i-i-s-test-cat-l',
            caption: i18n.t('forms.application.sitemap.test.i-i-s-test-cat-l.caption'),
            title: i18n.t('forms.application.sitemap.test.i-i-s-test-cat-l.title'),
            children: null
          }]
        }
      ]
